...
Mat.S <-  factor(as.matrix(read.csv("DIST_v10_A05_Y8.csv")))
...
write.csv(df.PropsM,"TS_v10_A05_Y8_2.csv",quote=F,row.names=F)
write.csv(Mat.S,"DIST_v10_A05_Y8_2.csv",quote=F,row.names=F)
