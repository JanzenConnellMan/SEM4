...
Mat.S <-  factor(as.matrix(read.csv("DIST_v10_A05_Y45.csv")))
...
write.csv(df.PropsM,"TS_v10_A05_Y45_2.csv",quote=F,row.names=F)
write.csv(Mat.S,"DIST_v10_A05_Y45_2.csv",quote=F,row.names=F)
