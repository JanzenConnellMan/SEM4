...
Mat.S <-  factor(as.matrix(read.csv("DIST_v75_A05_Y1.csv")))
...
write.csv(df.PropsM,"TS_v75_A05_Y1_2.csv",quote=F,row.names=F)
write.csv(Mat.S,"DIST_v75_A05_Y1_2.csv",quote=F,row.names=F)
